...
#define PI_CONTROLLER_DEFAULT {2.0f, 0.5f, 0.0f, 20.0f}

// { K, B, thetaDesired }
#define VIRTUAL_IMPEDANCE_DEFAULT {50.0f, 2.0f, 0.0f}

#define CURRENT_LIMIT_DEFAULT 3.0f  // Limite de corrente de torque(A)
